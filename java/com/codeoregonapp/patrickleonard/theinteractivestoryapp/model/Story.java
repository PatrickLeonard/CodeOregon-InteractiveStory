package com.codeoregonapp.patrickleonard.theinteractivestoryapp.model;

import com.codeoregonapp.patrickleonard.theinteractivestoryapp.R;
...
public class Story {
    ...
    public Story() {
        ...
        mPages[2] = new Page(
                R.drawable.page2,
                "You reach for your phone, but of course the battery is dead. Now what?",
        ...
        mPages[13] = new Page(
                R.drawable.page0,
                "You draw the line at talking cats! You plow forward through the flan wall, kicking left and right and scattering desserts to all corners of the kitchen. \"Please, %s! We're trying to help you!\" cries a flan from behind you. \"That's what the cat said, and now my kitchen is full of talking desserts!\" you retort. And where did that cat go, anyway?",
